...
# To save nvdi to Output_files folder, I'll use:  outraster.save(r"<location_path>\<name>.gdb" + "\\" + filename)
output = "Output_rasters"
os.mkdir(output)
output_directory = r"C:\Ryan_GIS\Class_10\Coding_Challenge_10\Output_rasters"
nvdi.save(os.path.join(output_directory, str(output_directory) + '_nvdi.tif',))
