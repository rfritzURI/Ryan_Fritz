...
class FlowDirection(object):
    ...
    def getParameterInfo(self):
        ...
        output_flow = arcpy.Parameter(name="output_raster",
                                 displayName="Output_raster",
                                 datatype="DERasterDataset",
                                 parameterType="Required",  # Required|Optional|Derived
...
class RegionGroup(object):
    ...
    def getParameterInfo(self):
        ...
        output_RG_raster = arcpy.Parameter(name="output_RG_raster",
                                 displayName="Output_depression_raster",
                                 datatype="DERasterDataset",
                                 parameterType="Required",  # Required|Optional|Derived
                                 direction="Output",  # Input|Output
                                 )
